...
export async function POST(req: Request) {
  ...
  try {
    ...
    const prompt = `
      ...
      4. features: אובייקט עם מאפייני הנכס (שטח דירה, שטח מגרש, מרפסת, חדרים, קומה, ממ"ד, חניה, מחסן, כיווני אוויר, מעלית). 
         חשוב מאוד: השתמש אך ורק בערכים המופיעים במפורש בתיאור הגולמי. אם נתון מסוים (כמו ממ"ד, מחסן או שטח) לא צוין - החזר עבורו null או "לא צוין". אל תנחש ואל תמציא נתונים חסרים.

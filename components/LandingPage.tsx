...
export const LandingPage: React.FC<LandingPageProps> = ({ details, isPreview = false, onReset, onSave, isSaving }) => {
  ...
  // SEO H1 - Accurate & Boring
  const boringSeoH1 = details.seoH1 || `נכס למכירה ב${details.address}`;
  // Marketing H2 - Engaging
  const excitingMarketingH2 = details.marketingH2 || details.generatedTitle;
  ...
  return (
    <div className="bg-slate-50 min-h-screen text-slate-800 font-sans flex flex-col">
      ...
      <header className="relative h-[90vh] min-h-[650px] text-white overflow-hidden shrink-0">
        ...
        {/* Info Box Overlay with 70% transparency and reinforced blur */}
        <div className="absolute bottom-10 right-6 md:right-16 z-20 max-w-[calc(100%-3rem)] md:max-w-5xl animate-slide-up">
            <div className="bg-black/30 backdrop-blur-xl p-6 md:p-10 rounded-3xl border border-white/10 shadow-2xl pointer-events-auto">
                <div className="animate-slide-up">
                    {/* Marketing Title in Hero is H2 */}
                    <h2 className="text-3xl md:text-5xl font-extrabold text-white mb-6 leading-tight font-sans">
                        {excitingMarketingH2}
                    </h2>

                    <address role="contentinfo" className="not-italic text-xl md:text-3xl font-bold text-brand-accent mb-8 flex items-center gap-4 w-fit font-sans">
                        <span className="inline-block w-2 h-8 bg-brand-accent rounded-full shadow-[0_0_20px_rgba(217,119,6,0.9)]"></span>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-7 space-y-10">
                <article className="bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-slate-100">
                    <div className="mb-10">
                        {/* Boring SEO H1 - Critical for Search Engines */}
                        <h1 className="text-lg font-bold text-slate-500 uppercase tracking-wider mb-2 font-sans">
                            {boringSeoH1}
                        </h1>
                        {/* Marketing Exciting H2 - Critical for User Conversion */}
        ...
        <section ref={leadFormRef} className="mt-24 max-w-4xl mx-auto relative">
             ...
             <div className="relative">
                <LeadForm 
                  ...
                  propertyTitle={excitingMarketingH2} 
